...
var lightBase = L.tileLayer('https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}.png', {
...
var customLayer = L.geoJson(null, {
  onEachFeature: function (feature, layer) {
    layer.bindPopup("<h3>" + feature.properties.event_type + "</h3><hr><p>" + new Date(feature.properties.event_date) + "</p><hr><p>Magnitude: " + feature.properties.event_type + "</p>");
  }
});
const tankLayer = customLayer
